...
Public Class Cryptography
    Public Shared Function Encrypt(ByVal strPlainText As String) As String
    ...
    Public Shared Function Decrypt(ByVal strPlainText As String) As String
        Dim strResult As String
        Dim cryptoStream As CryptoStream
    ...
    Public Shared Function GetCryptoTransform(strAction As String) As ICryptoTransform
