Public Class frmQATPressure
    ...
    Private Sub btnAccept_Click(sender As Object, e As EventArgs) Handles btnAccept.Click
        Try
            ...
            SharedFunctions.SaveQATPressure( _
                                 gdteTestBatchID, _
            ...
            'Update QAT Status
            SharedFunctions.UpdateQATStatus(False, False, gdrSessCtl.ShopOrder, strCurrQATEntryPoint, _
    ...
    Private Sub btnOverride_Click(sender As Object, e As EventArgs) Handles btnOverride.Click
        ...
        Try
            ...
            '"Accept" button was pressed in the Override Screen and the bypass lanes are not changed
            'Update the override id on the header record, close the form and update QAT Status for test completion
    ...
    Private Sub SaveTestResults()
        ...
        Try
            'Only save the failed tests to the table 
