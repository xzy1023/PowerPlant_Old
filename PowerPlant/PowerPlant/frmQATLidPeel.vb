Public Class frmQATLidPeel
    ...
    Dim resultServerDetails As New List(Of ServerModels.tblQATLidPeelResultDetail)()
    Dim _dbLocal As New LocalModels.PowerPlantLocalEntities()
    Dim resultLocalDetails As New List(Of LocalModels.tblQATLidPeelResultDetail)()
    ...
    Private Sub SaveTestHeader(testResult As Boolean)
        Dim resultServerHeader As New ServerModels.tblQATLidPeelResultHeader With {
        ...
        Dim resultLocalHeader As New LocalModels.tblQATLidPeelResultHeader With {
            .BatchID = gdteTestBatchID,
            .Facility = gdrSessCtl.Facility,
            .InterfaceID = gstrInterfaceID,
            .OverrideID = Nothing,
        ...
        Try
            ...
            If gblnSvrConnIsUp = True Then
                Try
                    _dbServer.AddTotblQATLidPeelResultHeader(resultServerHeader)
                    _dbServer.SaveChanges()
                Catch ex As Exception
                    SharedFunctions.SetServerCnnStatusInSessCtl(False)
                    _dbLocal.AddTotblQATLidPeelResultHeader(resultLocalHeader)
    ...
    Private Sub SetTestDetails(intLaneNo As Integer, intSampleNo As Integer)
        resultServerDetails.Add(New ServerModels.tblQATLidPeelResultDetail With {
            .BatchID = gdteTestBatchID,
            .LaneNo = intLaneNo,
            .RetestNo = intRetestNo,
        ...
        resultLocalDetails.Add(New LocalModels.tblQATLidPeelResultDetail With {
            .BatchID = gdteTestBatchID,
            .LaneNo = intLaneNo,
            .RetestNo = intRetestNo,
            .SampleNo = intSampleNo,
    ...
    Private Sub SaveTestDetails()
        Dim resultServerDetail As ServerModels.tblQATLidPeelResultDetail
        Dim resultLocalDetail As LocalModels.tblQATLidPeelResultDetail
            ...
            If gblnSvrConnIsUp = True Then
                Try
                    For Each resultServerDetail In resultServerDetails
                        _dbServer.AddTotblQATLidPeelResultDetail(resultServerDetail)
                    Next
                    _dbServer.SaveChanges()
                Catch ex As Exception
                    SharedFunctions.SetServerCnnStatusInSessCtl(False)
                    For Each resultLocalDetail In resultLocalDetails
                        _dbLocal.AddTotblQATLidPeelResultDetail(resultLocalDetail)
                    Next
                    _dbLocal.SaveChanges()
                End Try
            Else
