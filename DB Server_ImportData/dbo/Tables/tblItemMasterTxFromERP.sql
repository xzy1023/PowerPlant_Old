CREATE TABLE [dbo].[tblItemMasterTxFromERP] (
    [TxID]                    BIGINT          NOT NULL,
    [TxTime]                  DATETIME        CONSTRAINT [DF_tblItemMasterTxFromERP_TxTime] DEFAULT (getdate()) NOT NULL,
    [Action]                  CHAR (1)        NOT NULL,
    [Processed]               BIT             CONSTRAINT [DF_tblItemMasterTxFromERP_Processed] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_tblItemMasterTxFromERP] PRIMARY KEY CLUSTERED ([TxID] ASC)
);


GO

EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'''I'' Insert; ''U'' Update; ''D'' Delete', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'tblItemMasterTxFromERP', @level2type = N'COLUMN', @level2name = N'Action';
