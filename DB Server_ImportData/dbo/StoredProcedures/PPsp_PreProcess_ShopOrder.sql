...
-- Description:	Pre process for downloading MS Dynamics AX Shop Order to Power Plant
-- =============================================
CREATE PROCEDURE [dbo].[PPsp_PreProcess_ShopOrder]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT @vchTableName = 'tblShopOrder',  @vchFacility = NULL;
