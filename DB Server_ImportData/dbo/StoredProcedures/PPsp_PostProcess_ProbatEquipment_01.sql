...
-- =============================================
-- WO#1297      Oct. 14, 2014   Bong Lee
-- Description:	Post process for downloading MS Dynamics AX Probat equipment data to Power Plant for facility 01
-- =============================================
CREATE PROCEDURE [dbo].[PPsp_PostProcess_ProbatEquipment_01]
...
BEGIN
	...
	BEGIN TRY
		...
		SET @vchSQLStmt =  N'EXEC ' + @vchPPDBName + N'.dbo.PPsp_PostProcess_ProbatEquipment @vchFacility';
