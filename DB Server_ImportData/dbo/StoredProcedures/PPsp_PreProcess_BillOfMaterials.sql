...
-- Description:	Pre process for downloading MS Dynamics AX Bill Of Materials to Power Plant
-- =============================================
CREATE PROCEDURE [dbo].[PPsp_PreProcess_BillOfMaterials]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT @vchTableName = 'tblBillOfMaterials',  @vchFacility = NULL;
