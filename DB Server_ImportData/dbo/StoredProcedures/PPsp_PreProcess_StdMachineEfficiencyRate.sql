...
-- Description:	Pre process for downloading MS Dynamics AX Standard Machine Efficiency Rate to Power Plant
-- =============================================
CREATE PROCEDURE [dbo].[PPsp_PreProcess_StdMachineEfficiencyRate]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT @vchTableName = 'tblStdMachineEfficiencyRate',  @vchFacility = NULL;
