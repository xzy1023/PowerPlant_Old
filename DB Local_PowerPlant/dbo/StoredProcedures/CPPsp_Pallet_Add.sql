...
-- V6.78:		Jan 24, 2024 Zhiyuan Xiao
-- Description:	Insert Into tblPalletExt
-- V7.01:		Jun 05, 2025 Zhi & Saga
...
-- WO#1096  	AND tSO.PackagingLine = tPEQ.BPCSMachineID
		...
		-- ALM#11828  @vchOperator, @chrCreationDate, @chrCreationTime, @chrOrderComplete, @bitPrintStatus, -- WO#817
				...
				--V6.78
				INSERT INTO dbo.tblPalletExt (CreationDateTime, Creator) VALUES (@dteCreationTime, @vchCreator)
