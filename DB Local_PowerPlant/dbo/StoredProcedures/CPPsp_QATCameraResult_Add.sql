...
-- Description:	WO#17432 Insert record to the QAT camera verification result table
-- =============================================
CREATE PROCEDURE [dbo].[CPPsp_QATCameraResult_Add] 	
...
BEGIN
	BEGIN TRY
		...
		INSERT INTO tblQATCameraResult
			(
				BatchID
				,Facility
				,InterfaceID
