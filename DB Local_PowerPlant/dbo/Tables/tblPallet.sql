CREATE TABLE [dbo].[tblPallet] (
    ...
    [CreationDate]         CHAR (8)     CONSTRAINT [DF_tblPallet_CreationDate] DEFAULT (CONVERT([char](8),getdate(),(112))) NULL,
    [CreationTime]         CHAR (6)     CONSTRAINT [DF_tblPallet_CreationTime] DEFAULT (replace(CONVERT([char](8),getdate(),(114)),':','')) NULL,
    ...
    CONSTRAINT [PK_tblPallet_1] PRIMARY KEY CLUSTERED ([RRN] ASC)
);
