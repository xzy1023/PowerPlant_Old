Public Class _Default
    ...
    Protected Function GetUpdatedData() As DataTable
        ...
        Return sql.DBDT
    End Function
    Private Sub DeleteRecord(ByVal intTaskID As Integer, ByVal strDescription As String)
        Try
    ...
    Private Sub SaveRecord()
        Try
            ...
            If GetCurrentValue() = True Then
                ...
                If strTaskID = "0" Then
                    If CheckDuplicateKey(strTaskID) Then
                        lblErrMsg.Text = "Duplicate key found - " & strTaskID & ". Update process aborted!"
                        Exit Sub
                    End If
                End If
