    ...
    <form id="form1" runat="server" defaultbutton="btnDefault" defaultfocus="txtItemNumber">
        <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
           ...
           <div>
            ...
            <p  style="font-size: large; text-align: center;">Item Label Override Maintenance</p>
            <!-- Prompt for user -->
            <div>
      ...
      <tr>
        <td>
          <asp:Button Text="Override" BorderStyle="None" ID="Tab1" CssClass="Initial" runat="server" OnClick="Tab1_Click" />
          <asp:Button Text="General" BorderStyle="None" ID="Tab2" CssClass="Initial" runat="server" OnClick="Tab2_Click" />
          <asp:Button Text="Label Formats" BorderStyle="None" ID="Tab3" CssClass="Initial" runat="server" OnClick="Tab3_Click" />
          <asp:Button Text="Domicile" BorderStyle="None" ID="Tab4" CssClass="Initial" runat="server" OnClick="Tab4_Click"/>
...
<table style=" width: 100%;" frame="border">
                       <tr>
                        <td class="auto-style4"><asp:Label ID="lblAction" runat="server" CssClass="ActionMode"></asp:Label></td>
                    ...
                    <tr>
                       ...
                       <tr>
                        <td class="auto-style4">Facility:</td>
                     ...
                     <tr>
                        <td class="auto-style4">Desc. 1:</td>
                    ...
                    <tr>
                        <td class="auto-style4">Desc. 2:</td>
                        <td class="Override_YesOrNo">
                            </td>
                    ...
                    <tr>
                        <td class="auto-style4">Desc. 3</td>
                        <td class="Override_YesOrNo">
                            &nbsp;</td>
                    ...
                    <tr>
                        <td class="auto-style4">Pack Size:</td>
                        <td class="Override_YesOrNo">
                   ...
                   <tr>
                        <td class="auto-style4">Net Weight:</td>
                        <td class="Override_YesOrNo">
                    ...
                    <tr>
                        <td class="auto-style4">Net Weight UOM:</td>
                        <td class="Override_YesOrNo">
  ...
  <table style=" width: 100%;" frame="border">
                     <tr>
                        <td class="auto-style4">Bag Length Required:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Bag Length:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                    ...
                    <tr>
                        <td class="auto-style4">Override Item:</td>
                        <td class="Override_YesOrNo"></td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Print Shop Order Lot:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                        ...
                        <tr>
                            <td class="auto-style4">Print Case Label:</td>
                            <td class="Override_YesOrNo">&nbsp;</td>
                            <td class="Override_DataEntry">
                        ...
                        <tr>
                            <td class="auto-style4">Date to Print on Label:</td>
                            <td class="Override_YesOrNo">&nbsp;</td>
                            <td class="Override_DataEntry">
                        ...
                        <tr>
                            <td class="auto-style4">Production Date Desc. </td>
                            <td class="Override_YesOrNo"></td>
                            <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4" >Expiry Date Desc.:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <!-- WO#6430 ADD Start -->
                    <tr>
                        <td class="auto-style4">*Production Date Desc. on Box</td>
                        <td class="Override_YesOrNo"></td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">*Expiry Date Desc. on Box:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">*Additional Text 1:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">*Additional Text 2:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <!-- WO#6430 ADD Stop -->
                    <tr>
                        <td class="auto-style4">Slip Sheet: </td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Pallet Code:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                   <td class="auto-style4">Case Label Applicator:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                            <asp:DropDownList ID="ddlCaseLabelApplicator" runat="server" AppendDataBoundItems="True">
                                <asp:ListItem Value="0">None</asp:ListItem>
                                <asp:ListItem Value="1">Left Side Only</asp:ListItem>
                                <asp:ListItem Value="2">Right Side Only</asp:ListItem>
                                <asp:ListItem Value="3">Both Sides</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="ERP_Column">&nbsp;</td>
                    </tr>
                   ...
                   <tr>
                        <td class="auto-style4">Insert Brewer Filter:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                            <asp:RadioButtonList ID="rblInsertBrewerFilter" runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Value="False">No</asp:ListItem>
                                <asp:ListItem Value="True">Yes</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
 ...
 <table style=" width: 100%;" frame="border">
                    <tr>
                        <td class="auto-style4">Pkg Coder Date Fmt:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Case Label Date Fmt:</td>
                        <td class="Override_YesOrNo"></td>
                        <td class="Override_DataEntry">
                       ...
                       <tr>
                        <td class="auto-style4">Case Label Format 1:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Case Label Format 2:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Case Label Format 3:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Package Coder Format 1:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Package Coder Format 2:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Package Coder Format 3:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Filter Coder Format:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
 ...
 <table style=" width: 100%;" frame="border">
                    ...
                    <tr>
                        <td class="auto-style4" >Domicile Text 1:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Domicile Text 2:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Domicile Text 3:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Domicile Text 4:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Domicile Text 5:</td>
                        <td class="Override_YesOrNo"></td>
                        <td class="Override_DataEntry">
                    ...
                    <tr>
                        <td class="auto-style4">Domicile Text 6:</td>
                        <td class="Override_YesOrNo">&nbsp;</td>
                        <td class="Override_DataEntry">
           ...
           <td >
               <table style=" width: 100%;" frame="border">   
                   <tr style="font-weight: bold; color: #0000FF; background-color:#CCCCCC">
                       <td class="auto-style4">Item Major Class:</td>
                        <td class="auto-style4">Item Type:</td>
                        <td class="auto-style4">Label Weight:</td>
                        <td class="auto-style4">Saleable Unit Per Case:</td>
                        <td class="auto-style4">Packages Per Saleable Unit:</td>
                        <td class="auto-style5">Dim: D x H x W</td>
                   </tr>
                   <tr >
                        <td class="ERP_Column">
                       ...
                       <td class="ERP_Column">
                            <asp:Label ID="lblDim" runat="server" Text="Dim: D x H x W"></asp:Label>
                        </td>   
                   </tr>    
                   <tr style="font-weight: bold; color: #0000FF; background-color:#CCCCCC"> 
                        <td class="auto-style4">Prod. Shelf Life Days:</td>
                        <td class="auto-style4">Ship Shelf Life Days:</td>
                        <td class="auto-style4">Qty Per Pallet:</td>
                        <td class="auto-style4">Tie x Tier:</td>
                        <td class="auto-style5">Item Number:</td>
                   </tr>
                      <tr>
                       <td class="ERP_Column">
