CREATE TABLE [dbo].[tblGrindingSchedule] (
    ...
    [GSCSFT#]  INT          NOT NULL,
    CONSTRAINT [PK_tblGrindingSchedule] PRIMARY KEY CLUSTERED ([RRN] ASC)
);
...
CREATE NONCLUSTERED INDEX [IX_tblGrindingSchedule]
    ON [dbo].[tblGrindingSchedule]([GSCFAC] ASC, [GSCACTI] ASC);


GO

CREATE NONCLUSTERED INDEX [IX_tblGrindingSchedule_1]
    ON [dbo].[tblGrindingSchedule]([GSCFAC] ASC, [GSCPDTE] ASC, [GSCSDTE] ASC, [GSCSTIM] ASC);
