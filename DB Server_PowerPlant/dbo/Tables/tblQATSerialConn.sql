CREATE TABLE [dbo].[tblQATSerialConn] (
    [SerialConnID]   INT          IDENTITY (1, 1) NOT NULL,
...
--              tblQATSerialConn when the data in the table is changed.
-- =====================================================================
CREATE TRIGGER [dbo].[tgrQATSerialConn]
ON [dbo].[tblQATSerialConn]
AFTER INSERT, UPDATE, DELETE 
AS
   UPDATE dbo.tblDownLoadTableList set active = 1 where TableName = 'tblQATSerialConn'
